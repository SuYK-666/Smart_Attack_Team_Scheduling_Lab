...
| --- | --- | --- | --- |
| `entry01` | `10.92.10.10:8080` | Spring Framework RCE / Spring4Shell, `CVE-2022-22965` | `/flag.txt` |
...
| `files01` | `10.92.30.40:21` | ProFTPD mod_copy, `CVE-2015-3306` | `/flag.txt` and same value at `/var/ftp/flag.txt` |
