...
```text
host -> entry01 Spring RCE in DMZ -> jump01 router/bastion -> office services -> core services
```
...
| --- | --- | --- |
| `entry01` | `10.92.10.10` | Spring Framework RCE lab, published at `http://127.0.0.1:18080/` |
| `jump01` | `10.92.10.20`, `10.92.20.254`, `10.92.30.254` | Linux router and SSH bastion, published at `127.0.0.1:2222` |
...
3. `git01`: `/flag.txt`
4. `cache01`: `/flag.txt`
5. `files01`: `/flag.txt`, same value may be exposed through FTP for validation
